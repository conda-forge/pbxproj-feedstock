...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pbxproj-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14176&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pbxproj-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pbxproj` can be installed with:

```
conda install pbxproj
```

It is possible to list all of the versions of `pbxproj` available on your platform with:
